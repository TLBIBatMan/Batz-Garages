...
QBCore.Functions.CreateCallback("Batz-Garages:server:GetVehicleLocation", function(source, cb, plate)
    local src = source
...
RegisterNetEvent('Batz-Garages:server:UpdateOutsideVehicles', function(Vehicles)
    local src = source
...
RegisterNetEvent('Batz-Garages:server:parkVehicle', function(plate)
...
if Config.EnableTrackVehicleByPlateCommand then
    ...
    TriggerClientEvent('Batz-Garages:client:TrackVehicleByPlate', source, args[1])
