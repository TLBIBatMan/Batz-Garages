...
-- NEW ---
-- There is a new clientside export called 'TrackVehicleByPlate' that can be used to track vehicles by plate, this is useful for other scripts that want to track vehicles by plate (e.g. exports['Batz-Garages']:TrackVehicleByPlate(plate))
-- And the clientside event 'Batz-Garages:client:TrackVehicleByPlate'(e.g. TriggerEvent('Batz-Garages:client:TrackVehicleByPlate', plate))
...
Config.SpawnAtLastParkinglot = true -- spawn the vehicle at the last parked location if StoreParkinglotAccuratly = true, if set to true, make sure to apply / run patch1.sql
